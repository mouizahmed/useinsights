                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Disclosure.Panel className="text-gray-500">
                          ...
                          <Listbox value={selected} onChange={(chartType) => { setSelected(chartType); handleChartTypeChange(chartType.chartType); }}>
                            <div className="relative mt-1">
                              <Listbox.Button className={!selectedError ? ("relative w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left border border-gray-300 focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-300 sm:text-sm") : ("relative w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left border border-red-300 focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-300 sm:text-sm")}>
